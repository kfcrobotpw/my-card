      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center z-10 shrink-0">
            <div className="bg-white qr-contrast-box p-3 sm:p-3.5 rounded-2xl sm:rounded-3xl shadow-2xl flex flex-col items-center border border-white/80 transition-transform duration-200 hover:scale-105">
              {activeQrTarget ? (
                <div className="p-1">
                  <CrispQrCode
